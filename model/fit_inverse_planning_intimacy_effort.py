"""
Fit observer alpha for the inverse-planning effort experiment (food_inv-intimacy_effort_alt).

Parallel to model/fit_inverse_planning_alt.py for the alt-shown intimacy observer,
adapted for:
  ...
  - frozen actor weights from food_forw_intimacy_effort (forward_planning_effort_fit_results.csv),
    NOT the canonical food_forw_intimacy_desire fit.
...
def load_intimacy_effort_data(filepath: str = None):
    """Load and preprocess food_inv-intimacy_effort_alt data (posterior stage only).
...
def main():
    ...
    results_path = output_dir / "inverse_planning_intimacy_effort_fit_results.csv"
