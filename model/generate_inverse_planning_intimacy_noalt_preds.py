...
(`inverse_planning_intimacy_noalt_fit_results.csv`). This is different from the alt-
...
def load_noalt_fit_results(filepath=None):
    ...
    Reads the joint-fit CSV written by fit_inverse_planning_intimacy_noalt.py:main().
