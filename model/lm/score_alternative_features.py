...
--conditioning motivation (default): produces lm_alternatives_features_food_inv_intimacy_desire_noalt.csv
--conditioning relationship: produces lm_alternatives_features_food_inv_desire_intimacy_noalt.csv
"""
