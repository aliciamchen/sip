...
1. food_inv-intimacy_desire_alt: Infer intimacy from observed action (given reward condition), alternatives shown to participants
2. food_inv-desire_intimacy_alt:   Infer desire (reward condition) from observed action (given intimacy), alternatives shown
