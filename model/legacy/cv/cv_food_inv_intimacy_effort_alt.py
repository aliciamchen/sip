"""
Leave-one-scenario-out CV for the food_inv_intimacy_effort_alt observer.

Mirrors model/cv/cv_food_inv_intimacy_desire_alt.py but adapted for:
...
Outputs:
  - food_inv_intimacy_effort_alt/cv_preds_summary.csv  — one row per (scenario, action, effort, model);
...
from _helpers import (  # noqa: E402
    ...
    effort_table_kwargs as _table_kwargs,
    load_food_forw_intimacy_effort_actor_params,
    load_intimacy_effort_data,
)
from tables import IntimacyLevels, SCENARIO_LABELS, actions_effort  # noqa: E402
...
def main():
    print("=" * 60)
    print("LOSO cross-validation: food_inv_intimacy_effort_alt")
    print("=" * 60)
    ...
    output_dir = get_project_root() / "model" / "outputs" / "food_inv_intimacy_effort_alt"
