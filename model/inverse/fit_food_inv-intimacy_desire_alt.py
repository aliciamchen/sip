"""Fit alpha_observer for food_inv-intimacy_desire_alt.

Alt-shown intimacy observer; actor params frozen from the canonical food
forward fit. Writes outputs/food_inv-intimacy_desire_alt/fit_results.csv.
"""
...
EXPERIMENT_SLUG = "food_inv-intimacy_desire_alt"
...
def main():
    ...
    data, action, reward_condition, response, scenario_idx = load_intimacy_alt_data()
