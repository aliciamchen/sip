"""Fit alpha_observer for food_inv-desire_intimacy_alt.

Alt-shown reward (desire) observer; actor params frozen from the canonical food
forward fit. Writes outputs/food_inv-desire_intimacy_alt/fit_results.csv.
"""
...
EXPERIMENT_SLUG = "food_inv-desire_intimacy_alt"
...
def main():
    ...
    data, action, intimacy_condition, response, scenario_idx = load_desire_alt_data()
