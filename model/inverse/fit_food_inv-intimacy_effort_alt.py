"""Fit alpha_observer for food_inv-intimacy_effort_alt.

Effort-experiment 2-action observer infers intimacy. Actor params frozen from
food_forw_intimacy_effort fit.

Writes outputs/food_inv-intimacy_effort_alt/fit_results.csv.
"""
...
EXPERIMENT_SLUG = "food_inv-intimacy_effort_alt"
