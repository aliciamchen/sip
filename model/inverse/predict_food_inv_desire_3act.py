"""Generate predictions for food_inv_desire_3act.

Runs the reward observer on a per-scenario grid; writes preds_full.csv
...
def main():
    ...
    for variant, (obs_fn, kw_names, uses_v) in VARIANTS.items():
        ...
        result = obs_fn(**actor_kwargs, **desire_3act_table_kwargs(uses_v))
