"""Fit padded intimacy observer for food_inv_intimacy_desire_noalt (no-alt).
...
Writes outputs/food_inv_intimacy_desire_noalt/fit_results.csv.
"""
...
EXPERIMENT_SLUG = "food_inv_intimacy_desire_noalt"
...
def main():
    ...
    if padded is None:
        print(
            "Error: missing one of lm_alternatives_food_inv_intimacy_desire_noalt.csv, lm_alternatives_features_food_inv_intimacy_desire_noalt.csv, "
            "lm_scenario_v.csv, lm_alternatives_v_food_inv_intimacy_desire_noalt.csv. Run lm/generate_alternatives_motivation.py "
