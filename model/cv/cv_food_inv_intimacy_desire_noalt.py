...
Output (in model/outputs/):
  - food_inv_intimacy_desire_noalt/cv_preds_summary.csv
    One row per (scenario, observed_action, motivation, model), same schema
    as food_inv_intimacy_desire_noalt_preds_summary.csv.
  - cv_folds.csv
...
def main():
    ...
    if padded is None:
        print("ERROR: lm_alternatives_food_inv_intimacy_desire_noalt.csv or lm_alternatives_features_food_inv_intimacy_desire_noalt.csv missing.")
        sys.exit(1)
