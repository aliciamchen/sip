"""LOSO CV for nonfood_inv_joint_de (Study 3a).

Study 1b's joint desire+effort design on the nonfood stimulus set. Each fold
...
from model.cv._inverse_dispatcher import main_joint_de


if __name__ == "__main__":
    main_joint_de("nonfood_inv_joint_de")
