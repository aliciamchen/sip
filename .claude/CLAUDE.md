...
`lm/scenario_params.py` and `lm/generate_alternatives.py` accept a `--domain food|nonfood` flag that selects which scenario CSV to score and which output filename to write to.
