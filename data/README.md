...
Internal variable names use "reward" (e.g., `p_high_reward`, `desire_condition`) or "desire" rather than "desire" — the public manuscript uses "desire" but the data column names were fixed before that rename.
...
| `desire_condition` | Desire condition ("low" or "high") |
...
| `desire` | Desire condition ("low" or "high") |
...
### Study 2 — Inverse intimacy (`food_inv_intimacy/`)
...
### Study 3a — Effort inference (`food_inv_effort/`)
...
### Study 3b — Desire inference (`food_inv_desire/`)
...
### Study 4a — Joint desire + effort (`food_inv_joint_de/`)
...
### Study 4b — Joint desire + intimacy (`food_inv_joint_di/`)
