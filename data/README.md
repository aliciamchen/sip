...
The non-food studies repeat 1b's and 2b's designs on the non-food scenario set, so their CSVs will use exactly the same columns: Study 3a matches the Study 1b table above and Study 3b matches the Study 2b table. Study 3a's data is collected; Study 3b's has not been collected yet.
