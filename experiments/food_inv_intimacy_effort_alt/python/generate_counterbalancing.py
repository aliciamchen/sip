...
# 2 actions x 2 effort levels = 4 combinations; quadrupled to 16 to match 16 stories.
all_conditions = [
    ("action_1", "low"),
    ("action_1", "low"),
    ("action_1", "low"),
...
output_path = project_root / "experiments/food_inv_intimacy_effort_alt/json/full_counterbalancing.json"
