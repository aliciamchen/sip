...
Each participant sees all 16 scenarios (one trial each). The 6 cells are spread
across the 16 trial slots with a balanced design: every round holds two copies
of all 6 cells plus 4 extra cells, and the extras are assigned cyclically so
each cell is an extra in exactly 4 of the 6 rounds. Every cell therefore lands
in the same number of trial slots overall (256 each), giving uniform global cell
...
# sequences covers all 6 rounds. DataPipe assigns condition_assignment
