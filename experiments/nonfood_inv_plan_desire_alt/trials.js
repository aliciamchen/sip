...
export const CONFIG = {
  ...
  PIPE_EXPERIMENT_ID: "TBD_NONFOOD_DESIRE",
  ...
  const instructions = {
    ...
    pages: [
      ...
      `
            <div class="instructions-container">
              <h2>Social interactions survey</h2>
                <p>Please pay attention to the social relationship between the two people, and read each of the scenarios and the actions carefully! 🙂 You will receive $5 if you successfully complete the survey. </p>
