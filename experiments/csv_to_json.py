#!/usr/bin/env python3
"""Convert scenarios.csv to stimuli.json for each experiment."""

import csv
import json
from pathlib import Path

EXPERIMENTS = ["forw_plan", "inv_plan_intimacy", "inv_plan_reward"]
