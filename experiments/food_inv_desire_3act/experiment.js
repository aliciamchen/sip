...
async function createExperiment() {
  ...
  const stimuliWithConditions = stimuli.map((stimulus) => {
    ...
    // Spread all factor fields from the counterbalancing sequence (action_condition,
    // and any of reward_condition / effort_condition / intimacy_condition that apply
    // to this study). The counterbalancing script writes the field names directly.
