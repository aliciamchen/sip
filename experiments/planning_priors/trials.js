    ...
    pages: [
      `
            <div class="instructions-container">
                ...
                <p>For each action, we will ask you to evaluate the likelihood of the two people choosing that action. Please consider each option independently.</p>
