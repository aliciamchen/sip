// Study 3a — Joint inference over desire and effort, given intimacy, on the
// nonfood scenario set (scenarios_nonfood.csv). Same design as Study 1b
// (food_inv_joint_de): 4 (intimacy) × 3 (observed action). Intimacy descriptor
// preamble; both sliders on one page per phase — a continuous 0-100 desire
// slider and an effort slider between the two effort paragraphs.
...
export const CONFIG = makeConfig("nonfood_inv_joint_de");
export const INSTRUCTIONS_PAGES = STUDY_INSTRUCTIONS.nonfood_inv_joint_de;
export const COMPREHENSION_QUESTIONS =
  STUDY_COMPREHENSION_CHECKS.nonfood_inv_joint_de;
