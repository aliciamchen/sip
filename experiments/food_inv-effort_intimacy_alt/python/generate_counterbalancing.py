...
# 2 actions x 4 intimacy levels = 8 combinations; doubled to 16 to match 16 stories.
all_conditions = [
    ("action_1", 0),
    ("action_1", 50),
    ("action_1", 75),
...
output_path = (
    project_root / "experiments/food_inv-effort_intimacy_alt/json/full_counterbalancing.json"
)
