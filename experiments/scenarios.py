...
rows = [
    ...
    dict(
        ...
        name_0="Danielle",
        name_1="Katherine",
        vignette="Danielle and Katherine are driving together from San Francisco to Sacramento. They leave at 6am. Right when they leave, they stop at a gas station to get coffee. The coffee machine is out of order partway through pouring, so only one cup gets filled.",
