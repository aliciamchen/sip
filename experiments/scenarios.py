...
rows = [
    ...
    dict(
        ...
        high_risk_share="They dip the same chips, each taking bites and double-dipping them back into the dips.",
    ),
    dict(
        scenario_label="drinks",
        name_0="Noah",
        name_1="Ria",
        vignette="Noah and Ria are at a party. The bar is serving a one-off special cocktail the bartender invented — tequila mixed with ice cream. There is only enough left for a single cup.",
        desire_phrase="drink the cocktail",
        desire_low="Neither of them is especially curious about how the cocktail tastes.",
        desire_high="They are both very curious about how the cocktail tastes.",
        ...
        high_risk_share="They share the single cup, passing it back and forth and sipping from the same rim.",
    ),
    dict(
    ...
    dict(
        ...
        desire_low="Neither of them is very hungry yet — they both still have plenty of food for the rest of the hike.",
        desire_high="They are both tired and hungry, and running low on the food they packed.",
