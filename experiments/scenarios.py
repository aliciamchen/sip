...
rows = [
    ...
    dict(
        ...
        high_risk_share="They use their own utensils, which they have already used, to eat directly from the shared stack.",
    ),
    dict(
    ...
    dict(
        ...
        desire_high="They are both tired and hungry, and both of them want to eat some of the sandwich.",
    ...
    dict(
        ...
        desire_phrase="taste all the oyster types",
