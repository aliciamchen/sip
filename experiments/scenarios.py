...
`desire_phrase` is the scenario-specific completion of the desire-elicitation
question "How much do {name_0} and {name_1} both want to ___?" (e.g. "eat the hot
dog", "drink the coffee", "try each other's soups"), so the question names the
actual food instead of the generic "the food". It's used in Studies 1a and 1b,
where desire is inferred.
...
rows = [
    ...
    dict(
        ...
        desire_phrase="eat the pancakes",
        ...
        low_risk_share_effort_high="There is a station of extra utensils on the opposite side of the restaurant.",
        no_share="They order the pancakes. Dana eats from the stack, and when she gets full she asks for a box so that she can take the remaining portion home.",
        low_risk_share="They get extra utensils and use them to cut portions of the stack onto their own plates and eat from their own plates.",
        high_risk_share="They use their own used utensils to eat directly from the shared stack.",
    ),
    dict(
        ...
        desire_phrase="use the honey mustard sauce",
    ...
    dict(
        ...
        no_share="Liana and Serina watch the TV show in the living room, but they do not share the pasta. Liana eats the pasta while Serina eats a salad.",
    ...
    dict(
        ...
        high_risk_share="Camille eats some of the apple and then passes it to Haoyu, who eats the remaining portion.",
    ),
    dict(
        scenario_label="dip",
        name_0="Declan",
        ...
        no_share="Neither person tries the chips or dips before the party begins.",
        low_risk_share="They get two small appetizer plates, put some of each dip on each plate, and try the dips with chips from their own plates.",
        high_risk_share="Declan dips the chips into the dips, takes a bite from each to test the dip, then passes the rest of the chip with dip to Eric to finish.",
    ),
    dict(
        scenario_label="drinks",
        name_0="Noah",
        name_1="Ria",
        vignette="Noah and Ria are at a party. Noah is holding a drink that he tells Ria is a special cocktail that he invented, that he made himself at the bar. (It's tequila mixed with ice cream.)",
        desire_phrase="drink the cocktail",
        ...
        low_risk_share_effort_high="The bartender has stepped away to the back, and the clean cups are on a shelf behind the bar that's inaccessible without flagging someone down — which would take a long time given how packed the party is.",
        no_share="Ria does not drink any of Noah's drink. She goes to the bar and asks for her own separate drink.",
        low_risk_share="Ria gets a clean cup and Noah pours some of his drink into that cup. They each sip from their own cups.",
        high_risk_share="Ria takes Noah's cup and sips directly from his cup.",
    ),
    dict(
        ...
        desire_phrase="drink the coffee",
        ...
        low_risk_share_effort_low="Next to the coffee machine at this gas station is a self-serve stack of clean empty cups that customers can grab from.",
    ...
    dict(
        ...
        desire_phrase="try each other's drinks",
    ...
    dict(
        ...
        desire_phrase="eat the sandwich",
        ...
        low_risk_share_effort_high="Tony's backpacking knife is buried at the very bottom of his pack, under all of his gear.",
    ...
    dict(
        ...
        desire_phrase="taste the oysters",
        ...
        low_risk_share_effort_low="The restaurant is quiet tonight and the server is attentive — they expect that extra small plates and forks will come immediately whenever they ask.",
        low_risk_share_effort_high="The restaurant is packed and the server is slammed — flagging him down for extra small plates and forks would take a long time.",
        ...
        high_risk_share="For each oyster, they split it directly from the shell — each biting off half of the meat with their teeth and drinking some of the brine from the same shell.",
    ),
    dict(
        ...
        desire_phrase="eat the ice cream",
        desire_low="Neither of them particularly wants ice cream.",
        desire_high="They both really want ice cream.",
        low_risk_share_effort_low="There is a stack of clean spoons on the dessert table right next to the ice cream bowls.",
    ...
    dict(
        ...
        desire_phrase="try each other's soups",
    ...
    dict(
        ...
        desire_phrase="taste both dishes",
