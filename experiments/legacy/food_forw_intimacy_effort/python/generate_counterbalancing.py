...
# 4 intimacy levels x 2 effort levels = 8 combinations; doubled to 16 to match 16 stories.
all_conditions = [
...
output_path = project_root / "experiments/food_forw_intimacy_effort/json/full_counterbalancing.json"
