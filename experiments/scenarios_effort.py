...
rows = [
    ...
    dict(
        ...
        effort_high="All the extra forks and plates have already been cleared back to the kitchen, and the host is busy with other guests.",
    ...
    dict(
        ...
        name_0="Allison",
        name_1="Dana",
        vignette="Allison and Dana meet at a brunch restaurant together on Saturday morning. They each select their own dishes and then discuss what else to order. One intriguing choice is to also order a stack of the restaurant's famous pancakes to share, to eat for dessert after they eat their main dishes. After eating their main dishes, they are both still hungry and really want to order the pancakes.",
        effort_low="Their server has been attentive all morning and comes by the table quickly whenever they need something.",
        effort_high="The restaurant is slammed and their server has been hard to flag down all morning — every small request has taken a long time.",
        action_1="They order the pancakes, ask for an extra fork and knife, and when the utensils come they cut portions of the stack onto their own plates and eat from their own plates.",
        action_2="They order the pancakes and eat directly from the shared stack, each using their own fork to repeatedly go back and forth between the stack and their mouths.",
    ),
    dict(
        scenario_label="takeout",
        name_0="Emily",
        name_1="Elizabeth",
        vignette="Emily and Elizabeth are at a conference for work. After a long day of events, they get back to the conference hotel. It is late and all the nearby places are closed, so they decide to order chicken tenders delivered to the hotel. Both of them prefer honey mustard sauce to ketchup, but when they open the bag they see that the restaurant has only included one container of honey mustard (plus several ketchup packets).",
    ...
    dict(
        ...
        effort_high="All the clean plates are trapped mid-cycle in the dishwasher, and the serving spoon is dirty in the sink from cooking — washing plates and the spoon by hand would take a while.",
    ...
    dict(
        ...
        effort_high="The restaurant is packed and the server is slammed — flagging her down for extra small plates and forks would take a long time.",
        ...
        action_2="They split each oyster directly from the shell, each biting off half of the meat with their teeth and drinking about half of the brine, before switching off and eating the remaining portion.",
    ),
    dict(
        ...
        effort_high="The dessert table has been mostly cleared and the spoons have been put away in the kitchen.",
