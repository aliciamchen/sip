...
rows = [
    ...
    dict(
        ...
        action_2="Camille takes a bite out of the apple and then passes it to Haoyu, who takes a bite out of the same side of the apple. They alternate taking bites out of the same side of the apple.",
    ),
    dict(
        scenario_label="dip",
        name_0="Declan",
    ...
    dict(
        ...
        action_2="Ria takes Noah's cup and sips from the exact same spot where he drank.",
    ),
    dict(
    ...
    dict(
        ...
        action_2="They try each other's drinks by drinking directly from the rims of the glass, from the same spot where the other has been drinking.",
    ),
    dict(
        scenario_label="hike",
        name_0="Tony",
