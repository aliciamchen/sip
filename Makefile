...
.PHONY: all help clean test data data-forw data-intimacy data-desire \
...
help:
	...
	@echo "    analysis-exp2b   - Render Exp 2b (desire inference) analysis"
	...
	@echo "    data-desire      - Process desire inference data"
	@echo ""
	@echo "  Utilities:"
...
data: data-forw data-intimacy data-desire
...
model/outputs/inverse_planning_fit_results.csv: model/outputs/forward_planning_fit_results.csv \
                                        ...
                                        data/inv_plan_desire/main_trials_long.csv \
...
model/outputs/inv_plan_intimacy_preds_summary.csv model/outputs/inv_plan_desire_preds_summary.csv: \
...
analysis-exp2b: model/outputs/inv_plan_desire_preds_summary.csv
	quarto render analysis/exp-2b-inv-plan-desire-analysis.qmd

analysis-combined: model/outputs/inv_plan_intimacy_preds_summary.csv model/outputs/inv_plan_desire_preds_summary.csv
...
clean:
	...
	rm -f model/outputs/inv_plan_desire_preds_full.csv
	rm -f model/outputs/inv_plan_desire_preds_summary.csv
