...
The paper's figures are generated by the Python plotting scripts (all styled through the shared `plot_style.py`); the analysis qmds are working documents for visualization rather than the source of any paper figure.
